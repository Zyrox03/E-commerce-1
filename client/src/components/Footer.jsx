...
export const Footer = () => {
  return (
    <div dir="rtl" className="relative mt-16 bg-green-700 ">
          ...
          <div className="md:max-w-md lg:col-span-2">
            ...
            <div className="mt-4 lg:max-w-sm">
              <p className="text-md text-gray-300">
                تجعل شركتنا لباس الزفاف تجربة فريدة ولا تُنسى. مع التصاميم
                الأنيقة والجودة العالية، نسعى دائمًا لتلبية احتياجات عملائنا.
                اكتشفوا الأزياء التي تعكس شخصيتكم واحتفلوا بكل لحظة بثقة
                وأناقة.
              </p>
            </div>
          </div>
