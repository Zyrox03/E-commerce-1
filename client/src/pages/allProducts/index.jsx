...
const AllProducts = () => {
  ...
  return (
    <div className="min-h-screen bg-[#edf2f4] flex flex-col relative overflow-hidden">
      <Helmet>
        <title>  ELASALA AZ - Tous les Produits</title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="  ELASALA AZ - Tous les Produits" />
        <meta
        ...
        />
        <meta property="og:url" content="https://elasala-az.pages.dev/shop" />

        {/* Balises Twitter Card pour le partage sur Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="  ELASALA AZ - Tous les Produits" />
        <meta
